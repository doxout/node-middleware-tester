    ...
    var TestableServer = (function () {
        function TestableServer(mw) {
            ...
            this._ready = new Promise(function (resolve, reject) {
                _this.server.listen(0, function (_) {
                    return resolve(_this._isReady = true);
                });
            });
        }
        ...
        TestableServer.prototype.close = function () {
            ...
            return new Promise(function (resolve, reject) {
                return _this.server.close(resolve);
            });
        };
    ...
    var Tester = (function () {
        ...
        Tester.prototype.request = function (opt) {
            ...
            if (opt.body != null) {
                ...
                reqOptions.headers['Content-Type'] = 'application/json', reqOptions.headers['Content-Length'] = postdata.length;
            }
            if (opt.query != null)
