...
(function (mwtest) {
    ...
    var Tester = (function () {
        ...
        Tester.prototype.delete = function (url, body, opt) {
            opt = opt || {};
            opt.url = url;
            opt.method = 'DELETE';
            opt.body = body;
        ...
        Tester.prototype.deleteJSON = function (url, body, opt) {
            opt = opt || {};
            opt.json = true;
            return this.delete(url, body, opt);
        };
        ...
        Tester.prototype.deleteJSONAsync = function (url, body, opt) {
            return this.deleteJSON(url, body, opt);
        };
        return Tester;
    })();
